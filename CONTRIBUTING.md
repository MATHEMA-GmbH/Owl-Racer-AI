...
- Ensure any install or build dependencies are mentionend in the README.md.
...
1. Keep every part as simple as possible => no "over-engineering" or complicating
2. Follow the C# [Coding Conventions](https://docs.microsoft.com/en-us/dotnet/csharp/fundamentals/coding-style/coding-conventions) 
